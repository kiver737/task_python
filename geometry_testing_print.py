...
if __name__ == "__main__":
    ...
    # Вывод результатов геометрических функций
    print("Результаты выполнения функций:")
    print("Периметр и площадь прямоугольного треугольника (катеты 3 и 4):", right_triangle_perimeter_and_area(3, 4))
    print("Длина окружности и площадь круга (радиус=1):", circle_length_and_area(1))
    print("Площадь круга, ограниченного окружностью (длина окружности=2*pi):", area_from_circumference(2 * pi))
    print("Периметр и площадь треугольника по вершинам (0,0), (4,0), (0,3):", triangle_perimeter_and_area(0, 0, 4, 0, 0, 3))
    print("Метрики равностороннего треугольника (сторона=2):", equilateral_triangle_metrics(2))
